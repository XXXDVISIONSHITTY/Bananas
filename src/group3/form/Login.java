...
import group3.event.EventLogin;
import group3.event.EventMessage;
import group3.event.PublicEvent;
import group3.model.Model_Login;
import group3.model.Model_Message;
...
public class Login extends javax.swing.JPanel {
    ...
    private group3.swing.PanelSlide slide;
    ...
    private void initComponents() {
        ...
        slide = new group3.swing.PanelSlide();

        setBackground(new java.awt.Color(241, 196, 15 ));

        pic.setImage(new javax.swing.ImageIcon("src/group3/icon/login_image.png"));

        jLabel2.setFont(new java.awt.Font("satoshi", 0, 90));
        jLabel2.setForeground(new java.awt.Color(50, 13, 93));
        jLabel2.setText("B  A  N  A  N  A  S");
        ...
        slide.setBackground(new java.awt.Color(249   , 231, 159));
