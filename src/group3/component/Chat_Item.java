...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("src/group3/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("src/group3/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new group3.swing.JIMSendTextPane();
    ...
    private group3.swing.JIMSendTextPane txt;
