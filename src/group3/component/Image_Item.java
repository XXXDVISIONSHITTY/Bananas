...
import group3.event.EventFileReceiver;
import group3.event.EventFileSender;
...
public class Image_Item extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        progress = new group3.swing.Progress();

        progress.setForeground(new java.awt.Color(255, 255, 255));
        progress.setProgressType(group3.swing.Progress.ProgressType.CANCEL);
    ...
    private group3.swing.Progress progress;
