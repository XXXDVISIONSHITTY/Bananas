...
import group3.swing.JIMSendTextPane;
...
public class Chat_Bottom extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        sb.setBackground(new Color(249, 231, 159));
        ...
        cmd.setIcon(new ImageIcon("src/group3/icon/send.png"));
        ...
        cmdMore.setIcon(new ImageIcon("src/group3/icon/more_disable.png"));
        cmdMore.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (panelMore.isVisible()) {
                    ...
                    cmdMore.setIcon(new ImageIcon("src/group3/icon/more.png"));
