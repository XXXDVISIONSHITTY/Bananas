...
public class Chat_Left_With_Profile extends javax.swing.JLayeredPane {
    ...
    private void initComponents() {
        ...
        IaImage = new group3.swing.ImageAvatar();
        txt = new group3.component.Chat_Item();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.LINE_AXIS));

        IaImage.setBorderSize(0);
        IaImage.setImage(new javax.swing.ImageIcon("src/group3/icon/testing/dog.jpg")); // NOI18N
    ...
    private group3.swing.ImageAvatar IaImage;
