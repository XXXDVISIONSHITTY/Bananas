...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon("src/group3/icon/down.png").getImage();
        imageCancel = new ImageIcon("src/group3/icon/cancel.png").getImage();
        imageFile = new ImageIcon("src/group3/icon/file.png").getImage();
    }
